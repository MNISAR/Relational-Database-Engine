...
//                t.setFloFld(4, (float) ((Sailor) sailors.elementAt(i)).age);
        ...
        try{
            h1 = new HIndex("hash_index", keyType, 4,50);
        }catch(Exception e){
            e.printStackTrace();
        }
...
//                    new FldSpec(new RelSpec(RelSpec.outer), 4),
            ...
            am = new FileScan("sailors.in", Stypes, Ssizes,
                    (short) Stypes.length, (short) Sprojection.length,
                    Sprojection, null);

            IndexNestedLoopJoin inl = null;
            inl = new IndexNestedLoopJoin(Stypes, Stypes.length, Ssizes,
...
public class HashIndexJoinTest {
